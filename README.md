...
| File | Description |
|---|---|
| `Hotel_Booking_Analysis.ipynb` | Complete Python analysis notebook |
| `requirements.txt` | Python packages required for the project |
| `README.md` | Project documentation |
| `Hotel_Booking_Analysis_Report.pdf` | Project report |

## How to Run

The project was developed using Google Colab.

1. Open `Hotel_Booking_Analysis.ipynb` in Google Colab.
